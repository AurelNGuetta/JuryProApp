...
class ConnectJuryPage extends StatefulWidget {
  int evenement;
  ConnectJuryPage({Key key}) : super(key: key);

  _ConnectJuryPageState createState() => _ConnectJuryPageState();
}

class _ConnectJuryPageState extends State<ConnectJuryPage> {
