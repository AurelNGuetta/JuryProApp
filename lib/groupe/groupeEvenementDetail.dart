...
import 'package:learn_flutter/groupe/addGroupe.dart';
...
class GroupeEvenementDetailPage extends StatefulWidget {
  final int evenement;
  GroupeEvenementDetailPage({Key key, @required this.evenement})
      : super(key: key);

  _GroupeEvenementDetailPageState createState() =>
      _GroupeEvenementDetailPageState(evenement);
}

class _GroupeEvenementDetailPageState extends State<GroupeEvenementDetailPage> {
  int evenement;
  Evenement event;
  ...
  List data;
  List groupes, candidats, juries, criteres;
  ...
  Future<Evenement> fetchEvenement() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Echec du chargement des évènements');
    }
  }

  Future<Candidat> fetchAllCandidatInGroupes() async {
    setState(() {
      _isLoading = true;
    });
    final response =
        await http.get("${Constant.ip}/candidats/eventg/$evenement");
  ...
  Future<Groupe> fetchAllGroupes() async {
    ...
    final response = await http.get("${Constant.ip}/groupes/event/$evenement");
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(_createGroupe(evenement));
            },
          ),
          IconButton(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                                                            ...
                                                            return Container(
                                                              ...
                                                              child:
                                                                  GestureDetector(
                                                                      onTap:
                                                                          () {
                                                                        Navigator.of(context).push(_createCandidat(
                                                                            evenement,
                                                                            groupes[index]['groupe_id']));
                                                                      },
                                                                      child:
                                                                          Card(
                                                                        color: Colors
                                                                  ...
                                                                  children: <
                                                                    ...
                                                                    Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              "${candidats[i]["candidat_nom"]} ${candidats[i]["candidat_prenom"]}",
                                                                              textAlign: TextAlign.left,
                                                                              style: TextStyle(
                                                                                fontSize: 16.0,
                                                                            ...
                                                                            Text(
                                                                              "${candidats[i]["candidat_email"]}",
                                                                              style: TextStyle(
                                                                                fontSize: 16.0,
                                                                              ),
                                                                            ),
                                                                            Text(
                                                                              "${candidats[i]["candidat_telephone"]}",
                                                                              style: TextStyle(
                                                                                fontSize: 16.0,
                                                                              ),
                                                                            )
                        ...
                        Padding(
                          padding:
                              EdgeInsets.only(left: 10, top: 5, bottom: 20),
                          child: Align(
                            alignment: Alignment.centerLeft,
                            child: Text(
                        ...
                        Container(
                          ...
                          child: (_loadCritere)
                              ...
                              : Container(
                                  ...
                                  child: ListView.builder(
                                    itemCount:
                                        criteres == null ? 0 : criteres.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      return Card(
                                        elevation: 0,
  ...
  Route _createGroupe(int evenement) {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) =>
          AddGroupePage(evenement: evenement),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(0.0, 1.0);
        var end = Offset.zero;
        var curve = Curves.ease;
  ...
  Route _createCandidat(int evenement, int groupe) {
    return PageRouteBuilder(
  ...
  Route _createCriteria(int evenement) {
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => AddCriteriaPage(
        evenement: evenement,
      ),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        var begin = Offset(0.0, 1.0);
